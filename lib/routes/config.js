...
const { loadConfig, getConfigStatus, getConfigForClient, saveConfig, getRealPassword, getRecipientFilePath, getSheetNames } = require('../config');
...
// 配置状态（每次请求都从磁盘重新加载，确保手动改 conf.json 后刷新即生效）
